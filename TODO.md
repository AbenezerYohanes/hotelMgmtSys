...
- [ ] Update Reservations.js: Add form to create new reservations, edit existing ones using Modal.
- [ ] Update Guests.js: Add form to add/edit guests.
- [ ] Update Billing.js: Add form to create billings and process payments.
- [ ] Update Rooms.js: Add availability toggle or management forms.
- [ ] Add routing for individual views (e.g., /reservations/:id, /guests/:id).

### Admin Frontend
- [ ] Update Employees.js: Add form to add/edit employees.
- [ ] Update Attendance.js: Add form to mark attendance.
...
### Guest Frontend
- [ ] Update rooms.js: Add booking modal/form for selecting dates and booking rooms.
- [ ] Update dashboard.js: Add booking history and management.

### Staff Frontend
- [ ] Update Attendance.js: Add form to clock in/out.
- [ ] Update Leaves.js: Add form to request leave.
- [ ] Update Profile.js: Add form to update profile.

### Superadmin Frontend
- [ ] Update Hotels.js: Add form to create/edit hotels.
